...
from drs.apps.backup import strategy_validator as sv
from drs.apps.backup.models import BackupCtrl
from django.conf import settings
import os
from drs.apps.backup.xls_reader import Reader
from drs.apps.backup.xls_reader import PullBackupCtrlViaXls
from drs.utils.logger import Logger
from .strategy_picker import Picker
from django.utils import timezone
from .where_gener import Gener
...
class BackupCtrlTestCase(TestCase):
    ...
    def setUp(self):
        BackupCtrl.objects.create(Fschema='db', 
                                    ...
                                    Fbackup_status='2',
                                    Fdata_begin_date=timezone.datetime(2018, 4, 15),
                                    Fbackup_strategy='9',
                                    Fbackup_interval=99,
        ...
        BackupCtrl.objects.create(Fschema='db', 
                                    ...
                                    Fbackup_strategy='2',
                                    Fbackup_interval=7,
                                    Flast_date=timezone.datetime(2018, 4, 15),
                                    Fpriority='1',
                                    Fserver_ip='127.0.0.2',
                                    Fserver_info='Backup002',
                                    Fmodify_time=timezone.now())
        ...
        BackupCtrl.objects.create(Fschema='db', 
                                    ...
                                    Fsplit_field='eff_data',
                                    Fbackup_status='1',
                                    Fdata_begin_date=timezone.datetime(2010, 4, 15),
                                    Fbackup_strategy='2',
                                    Fbackup_interval=7,
                                    Flast_date=timezone.datetime(2013, 1, 1),
                                    Fpriority='0',
                                    Fserver_ip='127.0.0.2',
                                    Fserver_info='Backup002',
                                    Fmodify_time=timezone.now())
        BackupCtrl.objects.create(Fschema='db', 
                                    ...
                                    Fsplit_field='eff_data',
                                    Fbackup_status='0',
                                    Fdata_begin_date=timezone.datetime(2017, 4, 15),
                                    Fbackup_strategy='8',
                                    Fbackup_interval=7,
                                    Flast_date=timezone.datetime(2018, 2, 1),
                                    Fpriority='3',
                                    Fserver_ip='127.0.0.1',
                                    Fserver_info='Backup001',
                                    Fmodify_time=timezone.now())
        ...
        BackupCtrl.objects.create(Fschema='db', 
                                    ...
                                    Fbackup_strategy='8',
                                    Fbackup_interval=7,
                                    Flast_date=timezone.datetime(2018, 4, 10),
                                    Fpriority='3',
                                    Fserver_ip='127.0.0.2',
                                    Fserver_info='Backup002',
                                    Fmodify_time=timezone.now())
